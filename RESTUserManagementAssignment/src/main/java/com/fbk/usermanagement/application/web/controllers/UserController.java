...
/**
 * Controller for user management related operations.
 * 
 * @author Swamy
 */
@Controller
...
public class UserController {
	...
	public String getUsers(Model model) {
		log.debug("Request to fetch all users from the REST API");
	...
	public String editUser(@RequestParam(value = "id", required = true) String id, Model model) {
		...
		model.addAttribute("userAttr", userService.getById(id));
		return "adduser";
	}
